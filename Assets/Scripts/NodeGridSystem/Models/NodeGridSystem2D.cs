...
{
    public class NodeGridSystem2D<T>
    {
        readonly int _width;
        ...
        public static NodeGridSystem2D<T> VerticalGrid(int width, int height, float cellSize, Vector3 origin, bool debug = false)
        {
            return new NodeGridSystem2D<T>(width, height, cellSize, origin, new VerticalConverter(), debug);
        }

        public static NodeGridSystem2D<T> HorizontalGrid(int width, int height, float cellSize, Vector3 origin, bool debug = false)
        {
            return new NodeGridSystem2D<T>(width, height, cellSize, origin, new HorizontalConverter(), debug);
        }

        public NodeGridSystem2D(int width, int height, float cellSize, Vector3 origin, ACoordinateConverter coordinateConverter, bool debug)
        {
            this._width = width;
            this._height = height;
